...
fun LoginScreen(navController: NavController,loginViewModel: LoginViewModel){
        ...
        floatingButton = { /*TODO*/ })
    {
        Column(modifier = Modifier
            .fillMaxSize()
            .padding(10.dp), horizontalAlignment = Alignment.Start, verticalArrangement = Arrangement.Top)
        {
            SectionTitleTxt(title = "Login Into your existing Account".uppercase(), fontSize = 14)
            ...
            Column(modifier = Modifier
                ...
                AppTxt(text = "Email".uppercase(), fontSize = 15.sp, fontFamily = FontFamily.SansSerif, textAlign = TextAlign.Start, modifier = Modifier.fillMaxWidth())
                ...
                AppTxt(text = "Password".uppercase(), fontSize = 15.sp, fontFamily = FontFamily.SansSerif, textAlign = TextAlign.Start, modifier = Modifier.fillMaxWidth())
                CmnTxtField(
                    value = password,
                    label = {
                    },
                    ...
                    trailingIcon = {
                        iconBtn(icon = if(isPasswordVisible) Icons.Default.Visibility else Icons.Default.VisibilityOff
                            , colors =  IconButtonDefaults.iconButtonColors(containerColor = Color.Transparent, contentColor = Color(ShopAppConstants.AppPrimaryColor)))
                        {
